...
public class RageSpigotConfig {
    ...
    private static final String HEADER = "This is the main configuration file for RageSpigot.\n"
    ...
    public RageSpigotConfig() {
        ...
        try {
            ...
            RageSpigotConfigBridge.version = (String) prop.getOrDefault("version", "Unknown");
        }
    ...
    private void loadConfig() {
	    ...
	    RageSpigotConfigBridge.disableOpPermissions = this.getBoolean("disable-op", true);

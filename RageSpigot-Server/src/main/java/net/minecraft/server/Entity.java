...
import me.joeleoli.ragespigot.util.OptimizedRemoveUtil;
	...
	public void move(double d0, double d1, double d2) {
		...
		if (this.noclip) {
			...
			if (this.s_() && !flag && this.vehicle == null) {
				...
				this.M = (float) ((double) this.M + FastMath.sqrt(d21 * d21 + d23 * d23) * 0.6D);
				this.N = (float) ((double) this.N + FastMath.sqrt(d21 * d21 + d22 * d22 + d23 * d23) * 0.6D);

...
import me.joeleoli.ragespigot.event.potion.PotionEffectAddEvent;
import me.joeleoli.ragespigot.event.potion.PotionEffectExpireEvent;
import me.joeleoli.ragespigot.event.potion.PotionEffectExtendEvent;
import me.joeleoli.ragespigot.event.potion.PotionEffectRemoveEvent;
import me.joeleoli.ragespigot.knockback.KnockbackProfile;
import me.joeleoli.ragespigot.util.CraftPotionUtil;
...
//                    flag = false;
    ...
    public void a(Entity entity, float f, double d0, double d1) {
        if (this.random.nextDouble() >= this.getAttributeInstance(GenericAttributes.c).getValue()) {
            ...
            KnockbackProfile profile = this.getKnockbackProfile() == null ? RageSpigot.INSTANCE.getConfig().getCurrentKb() : this.getKnockbackProfile();

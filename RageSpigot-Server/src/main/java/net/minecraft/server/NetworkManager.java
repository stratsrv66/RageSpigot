...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
    ...
    public static final NioEventLoopGroup d = new NioEventLoopGroup(0, new ThreadFactoryBuilder().setNameFormat("Netty Client IO #%d").setDaemon(true).build());
    public static final EpollEventLoopGroup e = new EpollEventLoopGroup(0, new ThreadFactoryBuilder().setNameFormat("Netty Epoll IO #%d").setDaemon(true).build());
    public static final LocalEventLoopGroup f = new LocalEventLoopGroup(0, new ThreadFactoryBuilder().setNameFormat("Netty Local IO #%d").setDaemon(true).build());
